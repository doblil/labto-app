                    ...
                    <div className="filter__inputs" >
                        ...
                        <div className="filter__inner" style={{marginBottom:'10px', marginRight:'20px'}} >
                            ...
                            <select defaultValue='g'style={{width:'255px', height:'33px'}}>
                                <option  value={'g'}>проект1</option>
                                <option  value={'mg'}>проект2</option>
                                <option  value={'kg'}>проект3</option>
                                <option  value={'l'}>проект4</option>
                                <option  value={'ml'}>проект5</option>
                                <option  value={'pcs'}>проект6</option>
                            </select>
                        </div>
                    </div>
