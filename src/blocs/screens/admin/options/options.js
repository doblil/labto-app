...
export const Options = (props) => {
    ...
    return(
        <>
            <h6 style={{marginTop:'-15px'}}>В этом разделе можно добавить или удалить определенные данные, которые используются в сервисе. Любые изменения отображаются у абсолютно всех пользователей</h6>
