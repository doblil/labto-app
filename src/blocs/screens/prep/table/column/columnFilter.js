...
export const ColumnFilter = (props) => {
    ...
    const {  setNameSearch,  setProjectSearch, setIUse, setFavoriteSearch, iUse, favoriteSearch, currentFavorite} = props
        ...
        <div className="filter">
                <div className="filter__inputs" style={{justifyContent:'flex-start'}}>
                    ...
                    <div className="filter__wrap" style={{marginBottom:'14px'}}>
                        ...
                        <input type="text" className="filter__input" onChange={(e)=>{setProjectSearch(e.target.value)} }/>
