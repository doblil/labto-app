...
export const EquipmentOptions = (props) => {
    ...
    const {handleAddSame, handleDelete, handleIsolate, setShowChange, setShowStatusForm} = props
    ...
    return (
        <div className="desc__action-inner">
            ...
            <IsolateDialog/>
            <DeleteDialog/>
            <button className='desc__item-action' onClick={0}>Изменить</button>
            <button className='desc__item-action' onClick={0}>Списать</button>
            <button className='desc__item-action' onClick={() => {setShowStatusForm(true)}}>Статус</button>
            <button className='desc__item-action' onClick={0}>Поверка</button>
            <button className='desc__item-action' onClick={0}>Логи</button>
        </div>
    )
} 